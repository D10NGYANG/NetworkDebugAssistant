...
class UdpBroadSettingActivity : BaseActivity(), CompoundButton.OnCheckedChangeListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.swAutoSendLoop.setOnCheckedChangeListener(this)
    ...
    fun setPort(view: View) {
        val tag = "port"
        EditDialog(this)
            .setTittle(resources.getString(R.string.prompt))
            .setMsg(resources.getString(R.string.port))
            .addEdit(tag, "${binding.config?.port?: 0}", resources.getString(R.string.please_input_port))
    ...
    override fun onCheckedChanged(p0: CompoundButton?, p1: Boolean) {
        ...
        when(sw.id) {
            ...
            R.id.sw_auto_send_loop -> binding.config?.isAutoLoopSend = p1
